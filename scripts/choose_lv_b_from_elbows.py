#!/usr/bin/env python3
"""Choose a recommended LV-analysis B from saved elbow summaries."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--variance-elbows",
        default="output/lv_experiment/lv_null_variance_experiment/elbow_summary.csv",
    )
    parser.add_argument(
        "--rank-elbows",
        default="output/lv_experiment/lv_rank_stability_experiment/elbow_summary.csv",
    )
    parser.add_argument(
        "--output-path",
        default="output/lv_b_choice_summary.csv",
    )
    parser.add_argument(
        "--aggregation",
        default="max",
