...
# Stub out the heavy `src.dwpc_direct` module before importing dwpc_validation
# so the test doesn't pull in hetmatpy / scipy / numpy initialization.
fake_dwpc_direct = types.ModuleType("src.dwpc_direct")
fake_dwpc_direct.HetMat = object
fake_dwpc_direct.reverse_metapath_abbrev = lambda metapath: metapath
sys.modules.setdefault("src.dwpc_direct", fake_dwpc_direct)

from src import dwpc_validation  # noqa: E402
